...
features = ['apache_3j_diagnosis','gcs_motor_apache', 'd1_lactate_max', 'gcs_eyes_apache','apache_4a_hospital_death_prob', 'apache_4a_icu_death_prob']
...
def main():
    ...
    if submit:
        ...
        data= np.array([apache_3j_diagnosis, gcs_motor_apache, d1_lactate_max, gcs_eyes_apache, apache_4a_hospital_death_prob, apache_4a_icu_death_prob]).reshape(1, -1)
